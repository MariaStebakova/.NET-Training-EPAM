...
namespace Sorting.Test.NUnitTest
{
    ...
    public class BinarySearchEngineTests
    {
        ...
        public int? BinarySearchTest(int[] array, int value)
            => BinarySearchEngine<int>.BinarySearch(array, value);

        [Test]
        public void BinarySearchTest_WithNullArray()
            => Assert.Throws<ArgumentNullException>(() => BinarySearchEngine<int>.BinarySearch(null, 4));

        [Test]
        public void BinarySearchTest_WithNullValue()
            => Assert.Throws<ArgumentNullException>(() => BinarySearchEngine<string>.BinarySearch(new string[] {"1", "2", "4"}, null));
    }
}
