...
Решение (https://github.com/MariaStebakova/.NET-Training-EPAM/blob/master/M13.Streams.Task/StreamsDemo/StreamsExtension.cs)
...
Тесты (https://github.com/MariaStebakova/.NET-Training-EPAM/blob/master/M13.Streams.Task/ConsoleClient/Program.cs)